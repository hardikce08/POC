...
namespace AzureAd_Login_Sample.Controllers
{
    public class ContractController : Controller
    {
        ...
        public ActionResult Index(ContracListView model, string Filterby = "All")
        {
            ...
            var Allcontractrequest = WebHelper.GetWebAPIResponseWithErrorDetails(GetAllContractAPIURL, WebHelper.ContentType.application_json, WebRequestMethods.Http.Get, "", "", "", "");
        ...
        public ActionResult _CreateContract(Contract model)
        {
            ...
            else
            {
                ...
                var Contractrequest = WebHelper.GetWebAPIResponseWithErrorDetails(GetContractAPIURL, WebHelper.ContentType.application_json, WebRequestMethods.Http.Get, "", "", "", "");
        ...
        public ActionResult SaveContract(string serializeddata)
        {
            ...
            var Contractrequest = WebHelper.GetWebAPIResponseWithErrorDetails(CraeteContractAPIURL, WebHelper.ContentType.application_json, WebRequestMethods.Http.Post, postString, "", "", "");
        ...
        public ActionResult UpdateContract(string serializeddata, int id)
        {
            ...
            var postString = JsonConvert.SerializeObject(data);
            var Contractrequest = WebHelper.GetWebAPIResponseWithErrorDetails(UpdateContractAPIURL, WebHelper.ContentType.application_json, WebRequestMethods.Http.Put, postString, "", "", "");
            //var Allproductresponse = JsonConvert.DeserializeObject<AllProductResponse>(Contractrequest.ResponseString);
        ...
        public ActionResult DeleteContract(int id)
        {
            ...
            var Contractrequest = WebHelper.GetWebAPIResponseWithErrorDetails(DeleteContractAPIURL, WebHelper.ContentType.application_json, "DELETE", postString, "", "", "");
            return Content("Success");
        }
